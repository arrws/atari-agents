...
class DQNetwork:
    def __init__(self, input_dim, no_action):
        ...
        self.model.add(Dense(output_dim=64, activation='relu', input_dim=input_dim))
        self.model.add(Dense(output_dim=no_actions, activation='linear'))
