...
update_freq = 10000 # how often to train model ~ batch_size
...
replay_memory_size = 500000 # number of previous transitions to remember
observe_frames = 50000 # timesteps to choose actions randomly play
observe_frames = 10000
...
target_nn = DQNetwork(frame_size, game.no_actions, learn_rate, nn)
...
def do_train_step(sess):
    ...
    y_batch = []
    q_batch = target_nn.evaluate(sess, s2_batch)
